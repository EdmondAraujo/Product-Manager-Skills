...
- **Sources:** Dean's GTM/EOL Strategy Workshop deck, "Mastering Product End of Life Strategy" webinar, 5 EOL prompts in `product-manager-prompts`, 2 DOCX checklists. Anonymization held — no client names and no details carried over from client artifacts; public-record failure cases (Kodak, Zune, Vista, Nest Revolv, AT&T POTS, Amgen) are business history from Dean's own deck
